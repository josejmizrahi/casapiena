...
const badgeVariants = cva("inline-flex items-center gap-1 rounded-[6px] px-1.5 py-[3px] font-mono uppercase tracking-[0.08em] text-[9.5px] leading-none whitespace-nowrap border", {
  variants: {
    variant: {
