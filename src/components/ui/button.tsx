...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[10px] text-[14px] font-medium tracking-[0.005em] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-40 [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:stroke-[1.75]",
  {
    variants: {
      variant: {
      ...
      size: { default: "h-11 md:h-10 px-4", sm: "h-9 px-3.5 text-[13px] rounded-[9px]", lg: "h-12 px-6 text-[15px] rounded-[12px]", icon: "h-10 w-10 md:h-9 md:w-9 rounded-full" },
    },
